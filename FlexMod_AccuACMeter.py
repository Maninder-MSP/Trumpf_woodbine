            ...
            if USE_SUNSPEC:
                ...
                try:
                    ...
                    if rr.isError():
                        ...
                        # for Trumpf inverter:
                        self.ac_meter_total_apparent_power_L1 = (BinaryPayloadDecoder.fromRegisters(rr.registers[44:46], byteorder=Endian.Big)).decode_32bit_float() / 1000
                        self.ac_meter_total_apparent_power_L2 = (BinaryPayloadDecoder.fromRegisters(rr.registers[46:48], byteorder=Endian.Big)).decode_32bit_float() / 1000
                        self.ac_meter_total_apparent_power_L3 = (BinaryPayloadDecoder.fromRegisters(rr.registers[48:50], byteorder=Endian.Big)).decode_32bit_float() / 1000                        
                ...
                self.outputs[2][16] = self.ac_meter_phase_a_power
                self.outputs[2][17] = self.ac_meter_phase_b_power
                self.outputs[2][18] = self.ac_meter_phase_c_power
                self.outputs[2][19] = 0
